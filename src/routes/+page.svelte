...
<div class="min-h-screen grid grid-cols-1 2xl:grid-cols-5">
  <!-- Grinding Area (40% - 2/5, 33% on tablet) -->
  <div
    class="md:col-span-1 lg:col-span-2 min-h-[33vh] md:min-h-full border-b md:border-b-0 md:border-r lg:border-r border-green-500/20"
  >
    <GrindingArea />
  </div>
  ...
  <div
    class="md:col-span-1 lg:col-span-1 min-h-[33vh] md:min-h-full border-b md:border-b-0 md:border-r lg:border-r border-green-500/20"
  >
    <WidgetsArea />
  </div>
</div>
